...
namespace RealEstate_Dapper_Api.Repositories.ProductRepository
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<List<ResultProductAdevertListWİthCategoryByEmployeeDto>> GetProductAdvertListByEmployeeAsyncByTrue(int id)
        {
            ...
            using (var connection=_context.CreateConnection()){
                var values =await connection.QueryAsync<ResultProductAdevertListWİthCategoryByEmployeeDto>(query,parameters);
                return values.ToList();
            }
        }
        public async Task<List<ResultProductAdevertListWİthCategoryByEmployeeDto>> GetProductAdvertListByEmployeeAsyncByFalse(int id)
        {
