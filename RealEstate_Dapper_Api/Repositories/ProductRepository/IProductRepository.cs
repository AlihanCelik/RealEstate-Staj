...
namespace RealEstate_Dapper_Api.Repositories.ProductRepository
{
    public interface IProductRepository{
            ...
            Task<List<ResultProductAdevertListWİthCategoryByEmployeeDto>> GetProductAdvertListByEmployeeAsyncByTrue(int id);
            Task<List<ResultProductAdevertListWİthCategoryByEmployeeDto>> GetProductAdvertListByEmployeeAsyncByFalse(int id);
