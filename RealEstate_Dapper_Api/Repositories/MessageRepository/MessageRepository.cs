...
namespace RealEstate_Dapper_Api.Repositories.MessageRepository
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<List<ResutInBoxMessageDto>> GetInBoxLast3MessageListByReceiver(int id)
        {
            ...
            {
                var values = await connection.QueryAsync<ResutInBoxMessageDto>(query, parameters);
