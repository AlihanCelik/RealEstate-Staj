...
namespace RealEstate_Dapper_Api.Controllers
{
   [Route("api/[controller]")]
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("CategoryNameByMaxProductByRent")]
        public IActionResult CategoryNameByMaxProductByRent()
        {
            return Ok(_statisticsRepository.CategoryNameByMaxProductByRent());
        }
